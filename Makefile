...
CFLAGS=-c -Wall -ggdb3 -Iinclude -std=c99
LDFLAGS=-lmowgli
...
SOURCES=src/atheme_string.c src/connect.c src/hostname.c src/irc.c src/logger.c src/parser.c src/platform.c src/sigyn.c
OBJECTS=$(SOURCES:.c=.o)
EXE=build/sigyn
