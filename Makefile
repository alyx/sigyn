...
CFLAGS=-c -Wall -g -Iinclude -Ibuild/object/include -Wall -Wextra -D_MK_HOST
LDFLAGS=-lmowgli -ldl -Wl,-export-dynamic
...
SOURCES=src/string.c src/connect.c src/irc.c src/ircstream.c src/logger.c src/parser.c src/module.c src/queue.c src/sigyn.c
OBJECTS=$(SOURCES:.c=.o)
EXE=build/sigyn
